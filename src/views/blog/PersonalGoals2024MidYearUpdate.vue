<template>
  <div class="flex flex-col justify-start items-center container w-full mt-12 pb-12">
    <article class="prose dark:prose-invert lg:w-[856px]">
      <h1>2024 Goals: Mid-Year Update</h1>

      <em>June 30, 2024 - Reading Time: 5 minutes</em>

      <figure>
        <AdvancedImage
          :cld-img="cloudinary.createImageInstance('/lucianghimpu.com/2024-goals-mid-update/intro-image.jpg')"
          :plugins="cloudinary.plugins"
        />
        <figcaption>Sheila reviewing my progress</figcaption>
      </figure>
      ...
      <figure>
        <AdvancedImage
          ...
          :plugins="cloudinary.plugins"
        />
        <figcaption>Overview of the main goals</figcaption>
      </figure>
      ...
      <ul>
        <li>
          ...
          <span class="text-green-500 font-bold">Finances</span>
        </li>
        <li>
          I'm somewhat on track in
          <span class="text-yellow-500 font-bold">Fitness</span>
        </li>
        <li>
          But lagging behind in
          <span class="text-red-500 font-bold">Self Development and Creativity</span>
          🥲
        </li>
        <li>The rest of the goals are on track</li>
      </ul>

      <p>
        We will go into more detail for each category and moreover, I'll also
        <span class="font-bold text-indigo">recalibrate</span>
        some of the goals and drop some of them.
      </p>
      ...
      <p>
        ...
        <span class="text-blue-500 text-indigo">recovery.</span>
        I think I need to step up my recovery game. I'm not yet sure how, but I'll put some thought into it.
      </p>
      ...
      <ul>
        ...
        <li>
          I got
          <span class="font-bold text-indigo">my first stripe</span>
          at BJJ 🎉
        </li>
        <li>
      ...
      <ol>
        <li>
          ...
          priority and effort into BJJ
        </li>
        <li>
          <span class="text-red-500">Decrease</span>
          my effort into weightlifting
        </li>
        <li>
          <span class="text-blue-500">Improve</span>
          my recovery game
        </li>
      </ol>
      ...
      <figure>
        <AdvancedImage
          :cld-img="cloudinary.createImageInstance('/lucianghimpu.com/2024-goals-mid-update/fitness.png')"
          :plugins="cloudinary.plugins"
        />
        <figcaption>Recalibrated sub-goals</figcaption>
      </figure>
      ...
      <p>
        Reading-wise, I've started reading the
        <b>Foundation</b>
        series which I really enjoy! But I want to read some non-fiction books as well.
      </p>

      <figure>
        <AdvancedImage
          :cld-img="cloudinary.createImageInstance('/lucianghimpu.com/2024-goals-mid-update/self-dev.png')"
          :plugins="cloudinary.plugins"
        />
        <figcaption>Recalibrated sub-goals.</figcaption>
      </figure>
      ...
      <p>On the bright side, I'm doing well in this area. And funny enough, I've not put that much effort into it.</p>

      <p>There are some key things to mention related to this:</p>
      <ul>
        <li>
          I was
      ...
      <figure>
        <AdvancedImage
          :cld-img="cloudinary.createImageInstance('/lucianghimpu.com/2024-goals-mid-update/finances.png')"
          :plugins="cloudinary.plugins"
        />
        <figcaption>Recalibrated sub-goals.</figcaption>
      </figure>
      ...
      <p>Last but not least, I'm on track with these goals. So far this year I have:</p>
      <ul>
        <li>
        ...
        <li>
          Had the opportunity to spend some days in
          <span class="font-bold">🇪🇸 Barcelona</span>
          which was amazing
        </li>
        <li>
      ...
      <figure>
        <AdvancedImage
          :cld-img="cloudinary.createImageInstance('/lucianghimpu.com/2024-goals-mid-update/travel.png')"
          :plugins="cloudinary.plugins"
        />
        <figcaption>Recalibrated sub-goals.</figcaption>
      </figure>
      ...
      <p>
        As
        <span class="font-bold">Dyatlov</span>
        would say:
