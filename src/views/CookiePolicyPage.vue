  ...
  <div class="flex flex-col justify-start items-center container w-full mt-12 pb-12">
    <article class="prose dark:prose-invert lg:w-[856px]">
      ...
      <div class="flex flex-row">
        ...
        <input class="mx-2" type="checkbox" v-model="allowCookies" />
      </div>

      <p>
        This is the Cookie Policy for www.lucianghimpu.com, accessible from
      ...
      <ul>
        <li>Email: ghimpulucianeduard@gmail.com</li>
      </ul>
    </article>
  </div>
</template>
