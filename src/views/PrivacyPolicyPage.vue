  ...
  <div class="flex flex-col justify-start items-center container w-full mt-12 pb-12">
    <article class="prose dark:prose-invert lg:w-[856px]">
      ...
      <p>
        ...
        information that is collected and recorded by www.lucianghimpu.com and how we use it.
      </p>
      ...
      <p>
        ...
        www.lucianghimpu.com. This policy is not applicable to any information collected offline or
      ...
      <p>
        www.lucianghimpu.com follows a standard procedure of using log files. These files log
      ...
      <p>
        ...
        www.lucianghimpu.com, which are sent directly to users' browser. They automatically receive
      ...
      <p>
        Note that www.lucianghimpu.com has no access to or control over these cookies that are used
      ...
      <p>
        www.lucianghimpu.com's Privacy Policy does not apply to other advertisers or websites. Thus,
      ...
      <p>
        www.lucianghimpu.com does not knowingly collect any Personal Identifiable Information from
